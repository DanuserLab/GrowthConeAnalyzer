...
%if spur body added 20180412 used for frame 8 of zebrafish in vivo example
%II as was removing too many of the endpoints (which were singletons) 
%thinnedBodyAll = bwmorph(thinnedBodyAll,'spur'); 
