...
for iCh = 1:nChan
    ...
    display(['Finding Neurite Orientation Channel ' num2str(channels(iCh))]);
    ...
    if  exist(orientFile,'file')==2
        ...
        load([saveDir filesep 'params.mat']);
    ...
    for iFrame = startFrame:endFrame
        ...
        [backboneFrame,TSFigs] = GCAgetNeuriteOrient(img,ip.Results);
